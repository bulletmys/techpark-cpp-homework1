...
struct Asserter {
     ...
     */
    NORETURN static void CPPUNIT_API
    ...
    makeExpectedEqual(const std::string &expectedValue);
    ...
    makeExpectedLess(const std::string &expectedValue);
    ...
    makeExpectedLessEqual(const std::string &expectedValue);
    ...
    makeExpectedGreater(const std::string &expectedValue);
    ...
    makeExpectedGreaterEqual(const std::string &expectedValue);
    ...
    makeMessage(const std::string &expectedValue,
                const std::string &actualValue,
     ...
     */
    NORETURN static void CPPUNIT_API
    failNotEqual( std::string
    expected,
    std::string actual,
    const SourceLine &sourceLine,
    const AdditionalMessage &additionalMessage = AdditionalMessage(),
            std::string
    shortDescription = "equality assertion failed"
    );
     ...
     */
    static void CPPUNIT_API
    failNotGreaterEqual( std::string
    expected,
    std::string actual,
    const SourceLine &sourceLine,
    const AdditionalMessage &additionalMessage = AdditionalMessage(),
            std::string
    shortDescription = "greater equal assertion failed"
    );  /*! \brief Throws an Exception with the specified message and location.
